...
| 3 | Container | Data Service | C | `:37588` HTTP | 唯一持久化入口（submission 记录） |
...
flowchart LR
  ...
  W -->|POST /submissions| D[Data Service :37588]
...
| 变量 | 示例 | 说明 |
| - | - | - |
| `DATA_SERVICE_URL` | `http://data:37588` | Data Service 基址 |
...
| 变量 | 示例 | 说明 |
| - | - | - |
| `DATA_SERVICE_URL` | `http://<EC2-IP>:37588` | Data Service 基址 |
...
- Data Service：仅在 `:37588` 暴露；安全组最小放行：Lambda 出口 NAT 段 + 本地笔记本 IP。
